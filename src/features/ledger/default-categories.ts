...
export const defaultExpenseCategories: DefaultCategoryGroup[] = [
  { name: "餐饮", icon: "utensils", children: ["街边小吃", "早餐", "午餐", "晚餐", "夜宵", "零食", "饮料水果", "买菜原料", "油盐酱醋", "餐饮其他"].map((name) => ({ name, icon: name === "早餐" ? "coffee" : "utensils" })) },
  ...
  { name: "娱乐", icon: "sparkles", children: ["APP会员", "APP充值", "小赌怡情", "上网", "腐败聚会", "休闲玩乐", "旅游度假", "电影", "网游电玩", "麻将棋牌", "洗浴足浴", "运动健身", "花鸟宠物", "聚会玩乐", "茶酒咖啡", "卡拉OK", "歌舞演出", "电视", "娱乐其他"].map((name) => ({ name, icon: name === "旅游度假" ? "landmark" : name === "运动健身" ? "trending-up" : "sparkles" })) },
  ...
  { name: "投资", icon: "trending-up", children: ["会员", "打彩票", "利息支出", "保险", "出资", "基金", "股票", "P2P", "余额宝", "理财产品", "投资贷款", "银行存款", "证券期货", "外汇", "贵金属", "收藏品", "投资其他"].map((name) => ({ name, icon: "trending-up" })) },
  { name: "人情", icon: "heart", children: ["借出钱", "丧葬", "孝敬家长", "礼金红包", "物品", "孝敬", "请客", "给予", "代付款", "慈善捐款", "人情其他"].map((name) => ({ name, icon: "heart" })) },
  { name: "生意", icon: "landmark", children: ["进货采购", "人工支出", "材料辅料", "办公费用", "交通运输", "工程付款", "运营费", "会务费", "营销广告", "店面租金", "注册登记", "生意其他"].map((name) => ({ name, icon: "landmark" })) },
];

export const defaultIncomeCategories = [
  "理财", "债券", "医保余额", "社保", "滴滴", "中奖钱", "房租", "工资薪水", "利息", "兼职外快", "营业收入", "余额宝", "应收款", "生活费", "奖金", "基金", "礼金", "分红", "租金", "股票", "公积金", "工程款", "赔付款", "漏记款", "其他",
